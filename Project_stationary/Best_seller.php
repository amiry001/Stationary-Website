  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="side_bar">
          <div class="side_bar_blog">
            ...
            <div class="categary">
              <ul>
                            <li><a href="Best_seller.php" class="center"> BEST SELLER <i class="fa fa-line-chart"></i></a></li>
                            <li><a href="Recent_product.php" class="center"> RECENT PRODUCTS <i class="fa fa-cubes"></i></a></li>
              </ul>
            </div>
      ...
      <div class="col-md-9">
        <div class="row">
                <?php 
                    $query = "SELECT * FROM product WHERE `Best/Recent` = 'Best Seller';";
