        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Recent Products</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
  ...
  <div class="container">
    <div class="row">
          ...
          <div class="side_bar_blog">
            ...
            <div class="categary">
              <ul>
                            ...
                            <li><a href="Recent_product.php"s> RECENT PRODUCTS <i class="fa fa-cubes"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-9">
        <div class="row">
                <?php 
                    $query = "SELECT * FROM product WHERE `Best/Recent` = 'Recent Product';";
