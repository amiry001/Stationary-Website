  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="row">
                <?php 
                    $query = "SELECT * FROM `product` WHERE Category = 'School Stationary';";
                      ...
                      while ($row = mysqli_fetch_array($result)) {
                        ...
                        <div>
                          <form method="post" action="">
                              <div class="product_img center"><a href="Book_detail.php?b_id=<?php echo $row['Product_Id'] ?>"> <img class="img-responsive" src="img/<?php echo $row['Photo']; ?>" alt=""></a> </div>
